...
```{r}
  ...
  word.dfm<-dfm(words)
  bigram.dfm<-dfm(bigrams)
  trigram.dfm<-dfm(trigrams)
  tetragram.dfm<-dfm(tetragrams)
...
freq <- textstat_frequency(bigram.dfm)
bigram.freq <-freq$frequency
names(bigram.freq) <- freq$feature
freq <- textstat_frequency(trigram.dfm)
trigram.freq<-freq$frequency
names( trigram.freq) <- freq$feature
freq <- textstat_frequency(tetragram.dfm)
tetragram.freq <-freq$frequency
names(tetragram.freq) <- freq$feature
