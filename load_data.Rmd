...
Also in this step we remove the stop words (like 'the', 'a', 'an'...), using a stop words list from the 'tm' package, and any offensive word ("profanity filtering")

```{r}
cleanSentences <-function(rawSentences)
{
  offensive.words <- readLines("./raw_data/offensive_words.csv")
